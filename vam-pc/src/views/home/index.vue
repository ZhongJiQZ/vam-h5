      ...
      <div class="coin_tabs">
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane :label="$t('home.hotCoin')" name="hot">
            <el-table :data="currentCoinList0" style="width: 100%">
              <el-table-column
                prop="showSymbol"
                :label="$t('home.name')"
                align="left"
          ...
          <el-table :data="currentCoinList1" style="width: 100%">
              <el-table-column
                prop="showSymbol"
                :label="$t('home.name')"
                align="left"
...
export default {
  ...
  methods: {
    // {"id":45,"symbol":"ltcusdt","status":1,"showFlag":1,"coin":"ltc","baseCoin":"usdt","market":"binance","sort":3,"searchValue":null,"logo":"https://api-admi-malai.oss-ap-southeast-3.aliyuncs.com/waihui/litecoin.png","showSymbol":"LTC/USDT","type":2,"coinType":2,"amount":79.12,"open":0,"isCollect":2,"baseCoinUpperCase":"USDT","coinUpperCase":"LTC","symbolUpperCase":"LTCUSDT"},{"id":46,"symbol":"bnbusdt","status":1,"showFlag":1,"coin":"bnb","baseCoin":"usdt","market":"binance","sort":4,"searchValue":null,"logo":"https://api-admi-malai.oss-ap-southeast-3.aliyuncs.com/waihui/binance-coin.png","showSymbol":"BNB/USDT","type":2,"coinType":2,"amount":906.14,"open":0,"isCollect":1,"baseCoinUpperCase":"USDT","coinUpperCase":"BNB","symbolUpperCase":"BNBUSDT"},
    initCurrentCoinList(){
      // console.log(JSON.stringify(this.secondContractCoinList))
      this.currentCoinList0 = this.secondContractCoinList.filter(it => it.coinType == 2)
      this.currentCoinList1 = this.secondContractCoinList.filter(it => it.coinType == 1)
    },
