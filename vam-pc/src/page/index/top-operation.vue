<template>
  <div class="top-operation">
    ...
    <div class="operat-item" @click="$emit('openDialog')">
      <div class="operat-lang">
        <!-- {{ languageName }} / {{ exchangeName }} -->
        <!-- <i class="el-icon-caret-bottom"></i> -->
        <!-- <img class="img" :src="allImgUrl.top_lang_normal" /> -->
        <img class="img" src="../../assets/image/customer.png" />
        <!-- <img class="img-hover" :src="allImgUrl.top_lang_hover" /> -->
      </div>
    </div>
    <!-- 语言图标 -->
    <div class="operat-item">
