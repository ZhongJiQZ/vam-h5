...
export default [
  ...
  },
  {
    ...
    path: '/orderCenter',
    name: 'OrderCenter',
    component: () => import('@/views/assets/orderCenter.vue')
  },
  {
    alias: '/assetRecord',
    path: '/assetRecord',
    name: 'AssetRecord',
    component: () => import('@/views/assets/assetRecord.vue')
  },
  ...Home,
  ...Quote, // 行情
  ...Financial, // 理财
  ...
  //   name: 'Myassets',
  //   component: () => import('@/views/assets/index.vue'),
  //   redirect: '/myassets/home',
  //   children: [
  //     {
  //       path: 'home',
  //       name: 'MyassetsHome',
  //       component: () => import('@/views/assets/myassetsHome.vue') 
  //       // ✅ 把你现在 index.vue 里 “我的资产内容” 抽到这个组件
  //     },
  //     {
  //       path: 'order',
  //       name: 'OrderCenter',
