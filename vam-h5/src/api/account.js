...
export const updateUserAddress = (params) =>
  post(
    `/api/user/updateUserAddress?type=${encodeURIComponent(params.type)}&address=${encodeURIComponent(
      params.address
    )}&userId=${encodeURIComponent(params.userId)}`
)

export const updateUserAddressByEmail = (params) =>
  post(
    `/api/user/updateUserAddress?type=${encodeURIComponent(params.type)}&address=${encodeURIComponent(
      params.address
    )}&userId=${encodeURIComponent(params.userId)}
    &email=${encodeURIComponent(params.email)}
    &emailCode=${encodeURIComponent(params.emailCode)}`
)
