...
export default {
    ...
    mqttPassword: "rabbitmq@", // rabbitmq连接密码
    mqttMy:
      process.env.NODE_ENV === "production"
        ? "mqtts://xhqb.net/ws"
        : "mqtts://xhqb.net/ws", // mica-mqtt服务地址
    //白名单
    statusWhiteList: [],
    descriptionWhiteList: ["login in"],
  
    exchangeTime: 1000 * 60 * 3, //更新汇率时间
    /** 开发 ***/
    // baseUrl: "http://localhost:8220",
    // socketUrl: "ws://localhost:8220",
    /*** 生产环境 ***/
    baseUrl: "https://xhqb.net/api",
    socketUrl: "wss://xhqb.net/api",
    //时区字典
    TIMEZONE_DICT: [
